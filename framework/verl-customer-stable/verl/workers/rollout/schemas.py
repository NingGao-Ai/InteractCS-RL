    ...
    def initialize_request(cls, values):
        ...
        if (
            ...
            values["input_ids"], values["attention_mask"] = (
                tokens_without_prompt["input_ids"],
                tokens_without_prompt["attention_mask"],
            )
            ...
            multi_modal_inputs = tokens_without_prompt.copy()
        ...
        values["generation_prompt_ids"] = tokenization_dict_with_prompt["input_ids"][..., tokens_without_prompt["input_ids"].shape[-1] :]
